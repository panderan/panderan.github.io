var click_fps = 6;
var click_fps_interval = 1000 / click_fps;
var click_last = new Date().getTime();
...
*/  
  ...
  function loop(){
    var click_now = new Date().getTime();
    var elapsed = click_now - click_last;
    if (elapsed > click_fps_interval) {
        click_last = click_now - (elapsed % click_fps_interval);
        update.call(this);
        draw.call(this);
    }
